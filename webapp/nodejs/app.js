...
const dbEstateInfo = {
  host: process.env.MYSQL_ESTATE_HOST ?? "127.0.0.1", 
  port: process.env.MYSQL_ESTATE_PORT ?? 3306,
...
const dbChairInfo = {
  host: process.env.MYSQL_CHAIR_HOST ?? "127.0.0.1",
  port: process.env.MYSQL_CHAIR_PORT ?? 3306,
